...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse, search, and submit MCP servers for AI agents. The directory for the Model Context Protocol ecosystem." },
      { property: "og:title", content: "MCPHub — The MCP Server Marketplace for AI Agents" },
